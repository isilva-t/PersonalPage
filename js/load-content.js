...
function createProjectCard(project, isFeatured = false) {
    ...
    return `
        <div class="project-card ${isFeatured ? 'featured' : ''} bg-light-navy rounded-lg overflow-hidden hover:transform transition-all duration-300 flex-shrink-0">
            <div class="relative">
            ...
            <div class="p-6">
                ...
                <div class="flex gap-3 text-sm justify-center">
                    <a href="${project.github}" 
                       class="border border-cyan/30 text-cyan px-4 py-2 rounded hover:bg-cyan/10 transition-colors flex items-center gap-2" 
                       target="_blank" 
